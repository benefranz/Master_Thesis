...
* Baseline regressions without oil interaction
eststo clear
foreach var of varlist e5 e10 diesel{
	eststo baseline_`var': quietly areg ln_`var' i.date  1.treat#1.post, cluster(id) a(id)
...
esttab using "$tables/reg_red_unbalanced.tex", /// 
...
* Additional regressions without oil interaction
eststo clear
foreach var of varlist e5 e10 diesel{
	...
	estadd scalar pt = _b[1.treat#1.post]/(-0.03/1.19)*100
	estadd scalar pt_h = (_b[1.treat#1.post] + _b[1.highway#1.treat#1.post])/(-0.03/1.19)*100
}
foreach var of varlist e5 e10 diesel{
	...
	estadd scalar pt = _b[1.treat#1.post]/(-0.03/1.19)*100
	estadd scalar pt_c2 = (_b[1.treat#1.post] + _b[2.within5_quart#1.treat#1.post])/(-0.03/1.19)*100
	estadd scalar pt_c3 = (_b[1.treat#1.post] + _b[3.within5_quart#1.treat#1.post])/(-0.03/1.19)*100
	estadd scalar pt_c4 = (_b[1.treat#1.post] + _b[4.within5_quart#1.treat#1.post])/(-0.03/1.19)*100
}

esttab using "$tables/reg_red_unbalanced_add.tex", /// 
...
* Baseline regressions with oil interaction
eststo clear
foreach var of varlist e5 e10 diesel{
	eststo baseline_`var': quietly areg ln_`var' i.date  1.treat#1.post oil_de, cluster(id) a(id)
	estadd scalar pt = _b[1.treat#1.post]/(-0.03/1.19)*100
}

foreach var of varlist e5 e10 diesel{
	eststo controls_`var': quietly areg ln_`var' i.date 1.treat#1.post oil_de retail_recreation workplace, cluster(id) a(id)
	estadd scalar pt = _b[1.treat#1.post]/(-0.03/1.19)*100
}

esttab using "$tables/reg_red_unbalanced_oil.tex", /// 
keep(_cons workplace retail_recreation oil_de 1.treat#1.post) star(* 0.10 ** 0.05 *** 0.01) cells(b(star fmt(%9.6fc)) se(par)) brackets ///
stats(pt N r2,labels("Pass-Through (in \%)" "Observations" "R-squared") fmt(%9.2fc %9.0fc %9.4fc)) ///
mtitles("E5" "E10" "Diesel" "E5" "E10" "Diesel") ///
label booktabs replace nogap collabels(none) nonotes


* Additional regressions with oil interaction
eststo clear
foreach var of varlist e5 e10 diesel{
	eststo highway_`var': quietly areg ln_`var' i.date i.highway##i.treat##i.post oil_de retail_recreation workplace, absorb(id) cluster(id)
	estadd scalar pt = _b[1.treat#1.post]/(-0.03/1.19)*100
	estadd scalar pt_h = (_b[1.treat#1.post] + _b[1.highway#1.treat#1.post])/(-0.03/1.19)*100
}
foreach var of varlist e5 e10 diesel{
	eststo comp_`var': quietly areg ln_`var' i.date i.within5_quart##i.treat##i.post oil_de retail_recreation workplace, absorb(id) cluster(id)
	estadd scalar pt = _b[1.treat#1.post]/(-0.03/1.19)*100
	estadd scalar pt_c2 = (_b[1.treat#1.post] + _b[2.within5_quart#1.treat#1.post])/(-0.03/1.19)*100
	estadd scalar pt_c3 = (_b[1.treat#1.post] + _b[3.within5_quart#1.treat#1.post])/(-0.03/1.19)*100
	estadd scalar pt_c4 = (_b[1.treat#1.post] + _b[4.within5_quart#1.treat#1.post])/(-0.03/1.19)*100
...
esttab using "$tables/reg_red_unbalanced_oil_add.tex", /// 
keep(_cons workplace retail_recreation oil_de 1.treat#1.post 1.highway#1.treat#1.post 2.within5_quart#1.treat#1.post 3.within5_quart#1.treat#1.post 4.within5_quart#1.treat#1.post) star(* 0.10 ** 0.05 *** 0.01) cells(b(star fmt(%6.5fc)) se(par)) brackets ///
stats(pt pt_h pt_c2 pt_c3 pt_c4 N r2,labels("Pass-Through (in \%)" "Pass-Through Highway (in \%)" "Pass-Through Comp. 2nd" "Pass-Through Comp. 3nd" "Pass-Through Comp. 4nd" "Observations" "R-squared") fmt(%9.2fc %9.2fc %9.2fc %9.2fc %9.2fc %9.0fc %9.4fc)) ///
mtitles("E5" "E10" "Diesel" "E5" "E10" "Diesel") ///
label booktabs replace nogap collabels(none) nonotes
...
randomtag, count(200) gen(pick)
dataex id date ln_e5 ln_e10 ln_diesel post treat if pick
